...
for i in range(c_hours * len(days)):
  day_time.append(days[i//c_hours] + str(hours[i%c_hours]))


def generate_random_timetable():
    individual_timetable = []
    ...
    for class_name in classes:
        ...
        for i in range(len(subjects_required[grade])):
            ...
            individual_timetable.append(lesson)
    return individual_timetable
